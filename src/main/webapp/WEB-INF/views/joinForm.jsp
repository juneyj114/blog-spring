			...
			<div class="row">
				<div class="col-lg-8 posts-list" style="margin: 0px auto;">
					...
					<div class="comment-form" style="margin: 0px">
						...
						<form class="form-contact comment_form" action="/user/join"
							...
							<div class="row">
								...
								<div class="col-md-12">
									<div class="form-group" id="ImageContainer">
										<label class="genric-btn default-border radius" for="img__input" style="display:block">Select your avatar</label> 
										<input type="file"
											id="img__input" name="avatar" hidden readonly>
									</div>
								</div>
